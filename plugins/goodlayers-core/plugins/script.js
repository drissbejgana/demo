;(function (t, e) {
	...
	f.prototype = {
		setFromString: function (t, e) {
			var n =
				typeof e === "string" ? e.split(",") : e.constructor === Array ? e : [e]
			n.unshift(t)
						...
						if (
							...
							for (var o = 0; o < i.pagingCount; o++) {
								if (
									...
									(t =
										"thumbnails" === i.vars.controlNav
											? '<img alt="clinique-errahama-marrakech-image" src="' +
											  a.attr("data-thumb") +
											  '"' +
											  altText +
											  "/>"
					...
					if (p)
							...
							k.$slide
								...
								.prepend(
									'<div class="lg-video-cont ' +
										r +
										' "><div class="lg-video"><span class="lg-video-play"></span><img alt="clinique-errahama-marrakech-image" class="lg-object lg-has-poster" src="' +
										g +
										'" /></div></div>'
								)
					} else
						q
							...
							: k.$slide
									.eq(b)
									.prepend(
										'<div class="lg-img-wrap"><img alt="clinique-errahama-marrakech-image" class="lg-object lg-image" src="' +
											f +
											'" /></div>'
									)
					if (
			...
			;(c.prototype.init = function () {
				...
				if (
					...
					for (var g = 0; g < e.core.s.dynamicEl.length; g++)
						f +=
							'<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img alt="clinique-errahama-marrakech-image" src="' +
					...
					function b(a, b, c) {
						...
						h.youtube || h.vimeo || h.dailymotion
							...
							(e +=
								...
								'px"><img alt="clinique-errahama-marrakech-image" src="' +
								g +
								'" /></div>'),
							(i = "")
					}
...
!(function (Te, e, ke) {
	...
	function Ke(o, e, n) {
		...
		function J(e) {
			...
			if (
				...
				e ? null != g.startAt && K(g.startAt, 1) : K(it(b.dest, b.start, b.end))
			Be("load")
		}
		function K(e, t, a) {
			if (N && W.released && !a) {
	...
	Ne.on(Me, function (e) {
		...
		(function (t) {
			...
			var a =
				t.cancelAnimationFrame || t.webkitCancelAnimationFrame || t.clearTimeout
			qe = function (e) {
				a.call(t, e)
			}
		})(window),
									...
									n.scales &&
										...
										a.each(o, function (n) {
											...
											if (l in r && r[l].type === u)
												((d = r[l]).options = o), (d.ctx = i.ctx), (d.chart = i)
											else {
