				...
				if (
					...
					for (o = 0; o < i[a].middleZones[u].length; o++)
						i[a].middleZones[u][o].style.top =
							Math.round(b / 2 - i[a].middleZones[u][o].offsetHeight / 2) + "px"
		...
		c = function (r) {
			...
			1 == s &&
				...
				i[r].cpar !== t &&
					...
					i[r].c.html(
						'<img alt="clinique-errahama-marrakech-image" class="tp-slider-alternative-image" src="' +
							i[r].cpar.data("aimg") +
							'">'
					),
				...
				(e = e.split(";"))))
					if (e.hasOwnProperty(p)) {
						...
						switch (u[0]) {
							...
							case "z":
								l.z =
									"loop" === o ? parseInt(u[1], 0) : i.revToResp(u[1], i[t].rle)
								break
							case "bow":
								l.borderWidth = i
									.revToResp(u[1], 4, 0)
				...
				if (
					...
					if (
						...
						;(d =
							"slide" == p.basealign ? i[t].ulw : i[t].gridwidth[i[t].level]),
							(c =
								"slide" == p.basealign ? i[t].ulh : i[t].gridheight[i[t].level])
						var v =
								!jQuery.isNumeric(p.width) && p.width.indexOf("%") >= 0
									? !o._isstatic || o._incolumn || o._ingroup
										? p.width
					...
					if (
						...
						;(d = void 0 === d ? "" : d),
							e.append(
								'<rs-pzimg-wrap class="' +
									d +
									'" style="z-index:2;width:100%;height:100%;top:0px;left:0px;position:absolute;display:block"><img alt="clinique-errahama-marrakech-image" class="rs-pzimg" src="' +
									s +
